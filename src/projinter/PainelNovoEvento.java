...
public class PainelNovoEvento extends JPanel {

    public static final String CONFIR = "Confirmado";
    ...
    public PainelNovoEvento(AcessoBD acessoBD, CriaDataHora listar, ActionListener lstConfEvt, ActionListener lstCancelEvt) {
        setLayout(null);
        setOpaque(true);
        setSize(680, 620);
        ...
        txtNome2 = new JTextField("Nome do Evento");
        ...
        btnCancelar.addActionListener(lstCancelEvt);
        ...
        btnConfirmar.addActionListener(lstConfEvt);
        btnConfirmar.setActionCommand(CONFIR);
